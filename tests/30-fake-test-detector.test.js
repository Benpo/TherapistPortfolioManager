...
var ALLOWLIST = {
  ...
  '46.1-frame-no-surface-alt': 'preview Frame treatment source-audit — reads assets/app.css as text because jsdom does not evaluate CSS (a static audit is the only automated shape for a CSS contract), and counts the innerHTML sinks in assets/rich-toolbar.js as text because a sink census has no runtime observable; the runtime preview behavior is covered by the executing 46.1-inplace-swap and 46.1-format-in-preview jsdom gates, mirroring 25-08-single-source-audit'
};

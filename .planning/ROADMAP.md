...
- [x] 47-06-PLAN.md — Backup restore of the order sentinel (lock-step allowlist + sanitize-on-restore) + encrypted round-trip [ORDR-05]
...
- [x] 47-09-PLAN.md — Export split from 47-05 (sequential on export-modal.js): clipboard buildSessionMarkdown saved-order + unrated omission (D-21) + edit-aware severity-block placement (G-8) [ORDR-04, ORDR-07]
...
| 47. Session-Section Reordering | v1.4 | 9/10 | In Progress|  |

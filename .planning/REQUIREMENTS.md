...
- [ ] **FOUND-01**: CSS design token system with two-tier architecture (primitives + semantic tokens) replacing hardcoded colors
- [ ] **FOUND-02**: Self-hosted Rubik font (WOFF2) eliminating Google Fonts CDN dependency

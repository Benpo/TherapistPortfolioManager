...
updated: 2026-07-08T14:21:39Z
---

## Current Test

number: 1
name: Real-browser visual + dark-mode confirmation of the three gap-closure UI fixes (Chromium + Safari/WebKit)
expected: |
  Nav shows a single "?" affordance (no green Help pill); the "?" popover action row
  matches the anchor rows with hover intact on both; the EN welcome overlay shows two
  distinct paragraphs (value-first, then privacy), properly spaced, in light AND dark,

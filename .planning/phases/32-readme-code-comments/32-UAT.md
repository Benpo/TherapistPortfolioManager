...
updated: 2026-06-29T04:16:56Z
---

## Current Test

number: 1
name: README how-do-I recipe accuracy
expected: |
  Each recipe step is accurate and complete for the stated live file — no
  from-memory drift, no missing steps, no stale mechanics.

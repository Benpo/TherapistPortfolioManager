...
---
*Last updated: 2026-07-08 — Phase 40 complete: first-run welcome + attention coordinator + install nudge shipped and verified (ONBD-01..04, 4/4 must-haves, gap-closure round + on-device UAT passed). Prior: Phase 39 complete (help center + "?" entry, HELP-01..07). Milestone v1.3 "In-App Help, Onboarding & Changelog" started 2026-07-07 via `/gsd-new-milestone`; three pillars (help system, in-app changelog, docs-maintenance hard gate); Phase 26 design treated as a reconciled seed rather than a verbatim contract; rich-text editor deferred to v1.4.*

...
| 009 | note-field-preview | How does preview adapt to the 7 inline note fields + which unified treatment replaces the section-header orange? (Phase 46.1, Gaps 14+15) | A — in-place swap (Ben, 2026-07-17); treatment (Frame/Paper/Tint) still open | note-fields, preview, visual-language, phase-46.1 |

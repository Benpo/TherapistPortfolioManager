...
const LICENSE_I18N = {
  en: {
    ...
    errorDeviceLimit: "You've reached the activation limit (2 of 2 used). To free up a slot, open Sessions Garden in a browser where it's already activated and choose 'Deactivate.' If you no longer have access to the activated browser(s), contact contact@sessionsgarden.app.",
    errorGeneric: 'Activation failed. Please try again.',
    statusLicensed: 'Licensed',
    displayLabel: 'License Key',
    deactivateBtn: 'Deactivate This Browser',
    deactivatingBtn: 'Deactivating...',
    deactivateInfo: 'Frees one of your 2 activation slots.',
    deactivateConfirmTitle: 'Deactivate License?',
    deactivateConfirmMsg: "You will need to re-activate with an internet connection. This frees up one of your 2 activation slots.",
  ...
  he: {
    ...
    errorDeviceLimit: 'הגעת למגבלת ההפעלות (2 מתוך 2 בשימוש). כדי לשחרר מקום, פתחו את Sessions Garden בדפדפן שבו הוא כבר מופעל ובחרו \'בטל הפעלה\'. אם אין לכם גישה לדפדפנים המופעלים, פנו אל contact@sessionsgarden.app.',
    errorGeneric: 'ההפעלה נכשלה. נסה שוב.',
    statusLicensed: 'מורשה',
    displayLabel: 'מפתח רישיון',
    deactivateBtn: 'בטל הפעלה בדפדפן זה',
    deactivatingBtn: 'מבטל...',
    deactivateInfo: 'משחרר אחד מ-2 מקומות ההפעלה.',
    deactivateConfirmTitle: 'לבטל את הרישיון?',
    deactivateConfirmMsg: 'נדרשת הפעלה מחדש עם חיבור לאינטרנט. פעולה זו משחררת אחד מ-2 מקומות ההפעלה.',
  ...
  de: {
    ...
    errorDeviceLimit: 'Du hast das Aktivierungslimit erreicht (2 von 2 belegt). Um einen Platz freizugeben, öffne Sessions Garden in einem Browser, in dem es bereits aktiviert ist, und wähle „Deaktivieren". Falls du keinen Zugang mehr zu den aktivierten Browsern hast, kontaktiere contact@sessionsgarden.app.',
    errorGeneric: 'Aktivierung fehlgeschlagen. Bitte versuche es erneut.',
    statusLicensed: 'Lizenziert',
    displayLabel: 'Lizenzschlüssel',
    deactivateBtn: 'Diesen Browser deaktivieren',
    deactivatingBtn: 'Deaktiviere...',
    deactivateInfo: 'Gibt eine deiner 2 Aktivierungen frei.',
    deactivateConfirmTitle: 'Lizenz deaktivieren?',
    deactivateConfirmMsg: 'Du musst anschließend mit einer Internetverbindung erneut aktivieren. Dadurch wird eine deiner 2 Aktivierungen freigegeben.',
  ...
  cs: {
    ...
    errorDeviceLimit: 'Dosáhl/a jsi limitu aktivací (2 ze 2 obsazeny). Pro uvolnění místa otevři Sessions Garden v prohlížeči, kde je již aktivován, a zvol „Deaktivovat". Pokud již nemáš přístup k aktivovaným prohlížečům, kontaktuj contact@sessionsgarden.app.',
    errorGeneric: 'Aktivace se nezdařila. Zkus to znovu.',
    statusLicensed: 'Licencováno',
    displayLabel: 'Licenční klíč',
    deactivateBtn: 'Deaktivovat tento prohlížeč',
    deactivatingBtn: 'Deaktivuji...',
    deactivateInfo: 'Uvolní jednu z tvých 2 aktivací.',
    deactivateConfirmTitle: 'Deaktivovat licenci?',
    deactivateConfirmMsg: 'Budeš muset znovu aktivovat s připojením k internetu. Uvolní jednu z tvých 2 aktivací.',

...
var LANDING_I18N = {
  en: {
    ...
    screenshotLabels: ['Dashboard', 'Session in action', 'Client profile'],
  ...
  he: {
    ...
    screenshotLabels: ['דף הבית', 'פגישה אמיתית', 'כרטיס לקוח'],
  ...
  de: {
    ...
    screenshotLabels: ['Dashboard', 'Sitzung live', 'Kundenprofil'],
  ...
  cs: {
    ...
    screenshotLabels: ['Přehled', 'Sezení v akci', 'Profil klienta'],

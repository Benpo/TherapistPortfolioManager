...
var LANDING_I18N = {
  en: {
    ...
    features: [
      ...
      { icon: DOODLE_ICONS.offline, title: 'Your practice moves with you', desc: 'Works on your laptop, tablet, or clinic computer. Once installed — no internet needed.' },
      ...
      { icon: DOODLE_ICONS.coin, title: 'No subscriptions. No surprises.', desc: 'One payment, lifetime access. Your tool doesn\'t expire, and neither does your license.' },
      { icon: DOODLE_ICONS.notebook, title: 'Love your paper? Keep it.', desc: 'Keep writing during sessions if you prefer. Afterwards, summarize and organize everything digitally — so you can always find it later.' }
    ],
  ...
  he: {
    ...
    features: [
      { icon: DOODLE_ICONS.folder, title: 'הכל מסודר, כלום לא אבד', desc: 'כל הפגישות ורשומות הלקוחות שלך במקום אחד — מובנה, מסודר, וקל לניווט. אין יותר דפדוף בדפים ישנים או קבצים מפוזרים.' },
      { icon: DOODLE_ICONS.lock, title: 'האמון של הלקוחות שלך, מוגן', desc: 'ללא ענן. ללא חשבונות. ללא מעקב. נתוני הלקוחות שלך לא עוזבים את המכשיר שלך.' },
      { icon: DOODLE_ICONS.offline, title: 'הפרקטיקה שלך עוברת איתך', desc: 'עובד על המחשב הנייד, הטאבלט או מחשב הקליניקה שלך. אחרי ההתקנה — לא נדרש אינטרנט.' },
      ...
      { icon: DOODLE_ICONS.coin, title: 'ללא מנויים. ללא הפתעות.', desc: 'תשלום אחד, גישה לכל החיים. הכלי שלך לא פג, ואף הרישיון שלך.' },
      { icon: DOODLE_ICONS.notebook, title: 'אוהבת את הנייר? המשיכי.', desc: 'המשיכי לכתוב בפגישות אם זה נוח לך. אחר כך, סכמי ותארגני הכל דיגיטלית — כדי שתוכלי תמיד למצוא את זה מאוחר יותר.' }
    ],
  ...
  de: {
    ...
    features: [
      ...
      { icon: DOODLE_ICONS.offline, title: 'Deine Praxis geht mit dir', desc: 'Funktioniert auf deinem Laptop, Tablet oder Praxiscomputer. Einmal installiert — kein Internet nötig.' },
      ...
      { icon: DOODLE_ICONS.coin, title: 'Keine Abonnements. Keine Überraschungen.', desc: 'Eine Zahlung, lebenslanger Zugang. Dein Tool läuft nicht ab, deine Lizenz auch nicht.' },
      { icon: DOODLE_ICONS.notebook, title: 'Papier lieben? Behalte es.', desc: 'Schreib während der Sitzungen weiter, wenn du das bevorzugst. Anschließend fasst du alles digital zusammen — damit du es später immer findest.' }
    ],
  ...
  cs: {
    ...
    features: [
      ...
      { icon: DOODLE_ICONS.offline, title: 'Vaše praxe jde s vámi', desc: 'Funguje na vašem notebooku, tabletu nebo klinickém počítači. Po instalaci — internet není potřeba.' },
      ...
      { icon: DOODLE_ICONS.coin, title: 'Žádná předplatná. Žádná překvapení.', desc: 'Jedna platba, celoživotní přístup. Váš nástroj nevyprší a vaše licence také ne.' },
      { icon: DOODLE_ICONS.notebook, title: 'Milujete papír? Používejte ho.', desc: 'Pokračujte v psaní během sezení, pokud dáváte přednost. Pak vše shrňte a uspořádejte digitálně — abyste to vždy mohli najít.' }
    ],

...
var LANDING_I18N = {
  en: {
    ...
    heroSubtitle: 'Session documentation — no chaos, no paper. All data stays on your device — always.',
    ...
    features: [
      { icon: DOODLE_ICONS.folder, title: 'Everything organized, nothing lost', desc: 'All your sessions and client history in one place — structured, organized, and easy to navigate. No more flipping through pages or scattered files.' },
      ...
      { icon: DOODLE_ICONS.sparkle, title: 'Tracks what other tools can\'t', desc: 'Energetic imbalances, limiting beliefs, inherited emotions, severity levels — designed to support the way energy healers actually work.' },
    ...
    whyBuiltText: [
      ...
      'For years I documented sessions on paper, notebooks, and scattered files. When access to the digital tool I used during training expired, I went back to a drawer full of loose pages — and spent too long searching for past sessions every week.',
    ...
    faqItems: [
      ...
      { q: 'What healing methods does it support?', a: 'Designed for energy healing practices, it tracks your sessions. Track released emotions, physical imbalances, limiting beliefs, and more. This tool can support many methods.' },
    ...
    demoHint1: 'Click "Details" on a client \u2014 during remote sessions, their photo is right there so you can connect energetically without switching screens.',
  ...
  de: {
    ...
    features: [
      { icon: DOODLE_ICONS.folder, title: 'Alles organisiert, nichts verloren', desc: 'Alle deine Sitzungen und die Klientenhistorie an einem Ort — strukturiert, geordnet und einfach zu navigieren. Kein Blättern mehr in alten Seiten oder verstreuten Dateien.' },
      ...
      { icon: DOODLE_ICONS.sparkle, title: 'Verfolgt, was andere Tools nicht können', desc: 'Energetische Ungleichgewichte, einschränkende Überzeugungen, vererbte Emotionen, Schweregrade — entwickelt, um die Art zu unterstützen, wie Energie-Heilpraktiker wirklich arbeiten.' },
      { icon: DOODLE_ICONS.coin, title: 'Keine monatlichen Gebühren. Keine Überraschungen.', desc: 'Eine Zahlung, unbegrenzter Zugang.' },
      { icon: DOODLE_ICONS.notebook, title: 'Gewohnt, auf Papier zu schreiben? Weitermachen.', desc: 'Dokumentiere deine Sitzungen weiterhin auf Papier, wenn dir das liegt. Danach fasse alles digital zusammen — strukturiert und übersichtlich, damit du es später immer findest.' }
    ],
    ...
    whyBuiltText: [
      ...
      'Jahrelang habe ich Sitzungen auf Papier, in Notizbüchern und verstreuten Dateien dokumentiert. Als der Zugang zum digitalen Tool, das ich während meiner Ausbildung genutzt hatte, ablief, kehrte ich zu einer Schublade voller loser Seiten zurück — und verbrachte jede Woche zu viel Zeit mit der Suche nach vergangenen Sitzungen.',
    ...
    pricingSubtitle: 'Keine monatlichen Gebühren. Keine Überraschungen. Eine Zahlung, unbegrenzter Zugang.',
    ...
    faqItems: [
      ...
      { q: 'Welche Heilmethoden werden unterstützt?', a: 'Entwickelt für energetische Heilpraktiken — es verfolgt deine Sitzungen. Erfasse freigesetzte Emotionen, körperliche Ungleichgewichte, einschränkende Überzeugungen und mehr. Dieses Tool kann viele Methoden unterstützen.' },
    ...
    demoHint1: 'Klicken Sie auf "Details" bei einem Klienten \u2014 bei Fernsitzungen ist das Foto direkt da, um sich energetisch zu verbinden.',
    demoHint2: 'Probieren Sie "Sitzung hinzuf\u00fcgen" \u2014 das Alter des Klienten wird live neben dem Foto berechnet, genau wenn Sie es brauchen.',
    demoHint3: 'Pr\u00fcfen Sie die Schweregradskala \u2014 bewerten Sie vor und nach jeder Sitzung und beobachten Sie die Heilungsgeschichte.',
  ...
  cs: {
    ...
    features: [
      { icon: DOODLE_ICONS.folder, title: 'Vše uspořádáno, nic ztraceno', desc: 'Všechna vaše sezení a klientská historie na jednom místě — strukturovaně, uspořádaně a snadno přehledně. Konec listování ve starých stránkách nebo rozházených souborech.' },
      ...
      { icon: DOODLE_ICONS.offline, title: 'Funguje všude — i offline', desc: 'Po prvním nastavení váš nástroj běží přímo ze zařízení — v ordinaci, doma nebo na cestách.' },
      { icon: DOODLE_ICONS.sparkle, title: 'Sleduje to, co jiné nástroje nedokážou', desc: 'Energetické nerovnováhy, omezující přesvědčení, zděděné emoce, stupně závažnosti — navrženo pro způsob, jakým energetičtí léčitelé skutečně pracují.' },
      { icon: DOODLE_ICONS.coin, title: 'Žádné měsíční poplatky. Žádná překvapení.', desc: 'Jedna platba, neomezený přístup.' },
      { icon: DOODLE_ICONS.notebook, title: 'Zvyklí psát na papír? Pokračujte.', desc: 'Pokračujte v dokumentování sezení na papíře, pokud vám to vyhovuje. Poté vše shrňte a uspořádejte digitálně — strukturovaně a přehledně, abyste to vždy mohli najít.' }
    ],
    ...
    pricingSubtitle: 'Žádné měsíční poplatky. Žádná překvapení. Jedna platba, neomezený přístup.',
    ...
    faqItems: [
      ...
      { q: 'Jaké metody léčení podporuje?', a: 'Navržen pro energetické léčitelské praxe — sleduje vaše sezení. Sledujte uvolněné emoce, fyzické nerovnováhy, omezující přesvědčení a další. Tento nástroj může podporovat mnoho metod.' },
    ...
    demoHint1: 'Klikn\u011bte na "Detaily" u klienta \u2014 p\u0159i vzd\u00e1len\u00fdch sezeních je jeho fotka p\u0159\u00edmo p\u0159ed v\u00e1mi pro energetick\u00e9 spojen\u00ed.',

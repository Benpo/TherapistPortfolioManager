...
var LANDING_I18N = {
  en: {
    ...
    pricingItems: [
      ...
      '2 device/browser activations',
      'Full interface in: English, Hebrew, German, and Czech',
      'Works offline (install as app)',
      'All future updates included',
      'Full data export at any time'
    ],
    pricingDataNote: 'Data is stored locally in each browser and does not sync between them.',
    ...
    faqItems: [
      ...
      { q: 'Can I use it on multiple devices?', a: 'Your license includes 2 activations. Since the app runs entirely in your browser, each browser counts as a separate activation — for example, Chrome on your laptop and Safari on your tablet. You can deactivate anytime and reactivate on a different browser or device.' },
      ...
      { q: 'What if I need to change my browser or device?', a: 'Export your data first using the built-in backup, then deactivate your license in the current browser. This frees up a slot so you can activate on the new browser or device and import your backup there.' },
  ...
  he: {
    ...
    pricingDataNote: 'הנתונים נשמרים באופן מקומי בכל דפדפן ואינם מסתנכרנים ביניהם.',
    ...
    faqItems: [
      ...
      { q: 'האם אפשר להשתמש על כמה מכשירים?', a: 'הרישיון כולל 2 הפעלות. מכיוון שהאפליקציה רצה לחלוטין בדפדפן, כל דפדפן נחשב כהפעלה נפרדת — למשל, Chrome על הלפטופ ו-Safari על הטאבלט. אפשר לבטל הפעלה בכל עת ולהפעיל מחדש בדפדפן או מכשיר אחר.' },
      ...
      { q: 'מה אם צריך להחליף דפדפן או מכשיר?', a: 'ייצאו את הנתונים תחילה באמצעות הגיבוי המובנה, ואז בטלו את ההפעלה בדפדפן הנוכחי. זה משחרר מקום כדי שתוכלו להפעיל בדפדפן או מכשיר החדש ולייבא שם את הגיבוי.' },
  ...
  de: {
    ...
    pricingItems: [
      ...
      '2 Geräte-/Browser-Aktivierungen',
    ...
    pricingDataNote: 'Daten werden lokal in jedem Browser gespeichert und synchronisieren nicht untereinander.',
    ...
    faqItems: [
      ...
      { q: 'Kann ich es auf mehreren Geräten verwenden?', a: 'Deine Lizenz umfasst 2 Aktivierungen. Da die App vollständig im Browser läuft, zählt jeder Browser als separate Aktivierung — zum Beispiel Chrome auf dem Laptop und Safari auf dem Tablet. Du kannst jederzeit deaktivieren und in einem anderen Browser oder Gerät erneut aktivieren.' },
      ...
      { q: 'Was ist, wenn ich den Browser oder das Gerät wechseln muss?', a: 'Exportiere zuerst deine Daten mit der eingebauten Backup-Funktion, dann deaktiviere deine Lizenz im aktuellen Browser. Dadurch wird ein Platz frei, um im neuen Browser oder Gerät zu aktivieren und dort dein Backup zu importieren.' },
  ...
  cs: {
    ...
    pricingItems: [
      ...
      '2 aktivace zařízení/prohlížeče',
    ...
    pricingDataNote: 'Data jsou uložena lokálně v každém prohlížeči a nesynchronizují se mezi nimi.',
    ...
    faqItems: [
      ...
      { q: 'Mohu ho používat na více zařízeních?', a: 'Vaše licence zahrnuje 2 aktivace. Jelikož aplikace běží kompletně v prohlížeči, každý prohlížeč se počítá jako samostatná aktivace — například Chrome na notebooku a Safari na tabletu. Můžete kdykoli deaktivovat a znovu aktivovat v jiném prohlížeči nebo zařízení.' },
      ...
      { q: 'Co když potřebuji změnit prohlížeč nebo zařízení?', a: 'Nejprve exportujte data pomocí vestavěné zálohy, poté deaktivujte licenci v aktuálním prohlížeči. Tím se uvolní místo, abyste mohli aktivovat v novém prohlížeči nebo zařízení a importovat tam zálohu.' },

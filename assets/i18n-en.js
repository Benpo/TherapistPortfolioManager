...
window.I18N.en = {
  ...
  "help.tour.step.overview.body": "This is your quiet home base. Let's walk through running a session, end to end — at your own pace. You can leave any time.",
  "help.tour.step.addClient.title": "Adding a client",
  "help.tour.step.addClient.body": "Every journey starts with a person. This is where you add a new client to your garden.",
  "help.tour.step.startSession.title": "Starting a session",
  "help.tour.step.startSession.body": "When you sit down to work, you'll open a session from here.",
  "help.tour.step.setup.title": "Setting the scene",
  "help.tour.step.setup.body": "You begin by choosing the client, the date, and how you met — in the clinic, online, or another way.",
  "help.tour.step.heart.title": "The heart of a session",
  "help.tour.step.heart.body": "Here you capture the trapped emotions, their severity, and whether a Heart-Wall is present. This is the core of the work.",
  "help.tour.step.save.title": "Saving and keeping it safe",
  "help.tour.step.save.body": "When you save, the session is stored on this device. You can also export any session as a PDF — look for this export icon.",
  "help.tour.step.sessions.title": "Looking back",
  "help.tour.step.sessions.body": "All your saved sessions gather here, ready to browse, filter, and revisit.",
  "help.tour.step.reporting.title": "Seeing the whole picture",
  "help.tour.step.reporting.body": "The dashboard gently surfaces patterns across your work over time.",
  "help.tour.step.backup.title": "Keeping a copy",
  "help.tour.step.backup.body": "Your data lives only on this device — so a backup matters. This is where you export a safe copy.",
  "help.tour.step.help.title": "You're ready",
  "help.tour.step.help.body": "That's the whole path. The help center is always here if you need it — you'll find it under this question mark.",
  "help.tour.next": "Next",
  "help.tour.done": "Done",

...
window.I18N.en = {
  ...
  "schedule.folder.label": "Backup folder",
  "schedule.folder.helper": "Optional. The next time you save a scheduled backup, your browser will suggest this folder.",
  "schedule.folder.empty": "No folder chosen.",
  "schedule.folder.unsupported": "Folder picking is only available in Chromium-based browsers (Chrome, Edge, Brave).",
  "schedule.folder.pick": "Pick backup folder",
  "schedule.folder.repick": "Folder: {name} — Re-pick",
  "schedule.disableConfirm.title": "Turn off scheduled backups?",
  "schedule.disableConfirm.body": "The 7-day backup reminder banner will become active again. You will not lose any data.",

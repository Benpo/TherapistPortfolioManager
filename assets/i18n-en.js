...
window.I18N.en = {
  ...
  "help.tour.step.personalize.body": "Here we are — Settings. First, your session formats: name the kinds of work you actually do, and add your own. Dates live here too — choose the format your eyes are used to.",
  "help.tour.step.fields.title": "Your fields",
  "help.tour.step.fields.body": "Every session form starts from ready-made sections. Rename any of them — make the form truly your own — and switch off what you don't use. Nothing you disable is ever deleted.",
  "help.tour.step.snippets.title": "Your words",
  ...
  "help.tour.step.ready.body": "The app now speaks your way. This menu travels with you on every page. When someone new arrives, Add Client welcomes them in; Add Session begins the work itself. Let's open a session together.",
  "help.tour.step.setup.title": "Setting the scene",
  ...
  "help.tour.step.heart.body": "This is where the work lives — each trapped emotion you find and release. Nearby sit the severity scales — how heavy each issue felt, before and after — and the Heart-Wall section.",
  ...
  "help.tour.step.backup.title": "Keeping a copy",
  "help.tour.step.backup.body": "Everything here lives only on this device — so a copy matters. This small cloud creates an encrypted backup, and its color gently lets you know when one is due.",
  "help.tour.step.help.title": "You're ready",
  "help.tour.step.help.body": "That's the whole path — though not all of Sessions Garden. Behind this question mark lives the Help center: plain-language guides to everything we didn't walk — how often your backups run, the snippet library, the Heart-Wall, choosing an export format, and more. There's more in the app to meet, too, like the Reporting tab, quietly turning your sessions into numbers over time. It's here on every page — and this tour waits alongside it, whenever you'd like to walk again.",
  "help.tour.next": "Next",
  "help.tour.done": "Done",

...
window.I18N.en = {
  ...
  "settings.sessionTypes.add.saveAria": "Save new type",
  "settings.sessionTypes.add.invalid": "Enter a name that isn't already in the list.",
  "settings.sessionTypes.locked.tooltip": "Built-in types can be renamed but not deleted.",
  "settings.sessionTypes.rename.aria": "Rename this session type",
  "settings.sessionTypes.delete.aria": "Delete this session type",
  "settings.sessionTypes.savedToast": "Session types updated.",
  "settings.sessionTypes.empty": "No custom types yet. Add one below.",
  ...
  "settings.sessionTypes.confirm.reassign.title": "Delete this session type?",
  "settings.sessionTypes.confirm.reassign.body": "{count} sessions use this type. Delete anyway? Those sessions will be reassigned to “Other”.",

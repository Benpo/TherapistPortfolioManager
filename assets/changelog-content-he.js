...
(function () {
  ...
  window.CHANGELOG_CONTENT_HE = [
    ...
    // v1.2 — Personalize, session formats & faster finding
    {
      ...
      anchor: "v1-2",
      date: "יולי 2026",
      lede: "אפשר להתאים את Sessions Garden באופן אישי — עם פורמט התאריך שלך, סוגי המפגשים שלך ודרכים מהירות יותר למצוא כל מפגש.",
      highlights: [
        "לשונית 'התאמה אישית' חדשה מאפשרת לבחור כיצד יופיעו התאריכים בכל האפליקציה.",
        "אפשר לשנות את שמות סוגי המפגשים המובנים או להוסיף משלך.",

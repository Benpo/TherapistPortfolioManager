...
(function () {
  ...
  window.CHANGELOG_CONTENT_HE = [
    ...
    // v1.4 — Richer Sessions: formatted notes that keep their shape
    {
      ...
      anchor: "v1-4",
      date: "יולי 2026",
      lede: "הגרסה הזו שומרת על הצורה של ההערות שלכם — טקסט מודגש, רשימות וכותרות נשארים מעוצבים יפה בכל מקום שבו קוראים או משתפים.",
      highlights: [
        "טקסט מודגש, נטוי, רשימות תבליטים וממוספרות וכותרות מופיעים עכשיו כטקסט מעוצב כשקוראים מפגש שמור.",
        "קובצי PDF מיוצאים שומרים על העיצוב, כולל טקסט בעברית מימין לשמאל.",
        "העתקה או שיתוף של מפגש שומרים את ההערות בדיוק כפי שכתבתם.",
      ],
      categories: {
        new: [
          "קריאת מפגש שמור מציגה עכשיו את ההערות כטקסט מעוצב, כך שהדגשות, רשימות וכותרות נראות כפי שהקלדתם.",
        ],
        improved: [
          "ייצוא ל-PDF שומר עכשיו על הדגשות, נטוי, רשימות תבליטים וממוספרות, רשימות מקוננות וכותרות הערה — עם עברית מימין לשמאל שנשמרת נכון.",
          "העתקת מפגש או שמירתו כקובץ טקסט שומרת את ההערות בדיוק כפי שנכתבו.",
        ],
      },
    },

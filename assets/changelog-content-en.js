...
(function () {
  ...
  window.CHANGELOG_CONTENT_EN = [
    ...
    // ═══ v1.4 — Richer Sessions: formatting your notes, and notes that keep their shape ═══
    {
      ...
      highlights: [
        "A formatting toolbar above every note field and in the export editor: bold, italics, bullet and numbered lists, headings, indenting, undo and redo — with keyboard shortcuts on a computer.",
        "An Edit / Preview switch on the toolbar: Preview swaps the writing area for a framed view of the finished result — in your notes and in the export editor alike.",
        "Your formatting keeps its shape everywhere — saved sessions read back as styled text, and PDF exports preserve it, Hebrew right-to-left included.",
      ],
      categories: {
        new: [
          ...
          "A built-in preview: the toolbar's Edit / Preview switch swaps the writing area for a framed view of the finished result — one clean view at a time, and Ctrl+E (Cmd+E on a Mac) flips between the two.",
          "Reading a saved session shows your notes as styled text — bold, lists, and headings look the way you typed them.",
        ],
        improved: [
          "Formatting flows as you type: Ctrl+B and Ctrl+I, a dash or a number starts a list that continues on its own, Tab nests list items, and accepting a snippet suggestion inside a list stays on the same line.",
          "The export editor opens roomier, with a maximize option and the full formatting toolbar — and moving between the export steps never loses your edits.",
          "The before-and-after emotion ratings come pre-selected when you export — uncheck them and that export leaves the severity ratings out, in both the PDF and a copied summary.",
          "Exports describe the Heart-Wall result in words — Heart-Wall removed, or Heart-Wall present, not removed this session — in place of a bare yes or no.",
          "PDF exports preserve bold, italics, lists and their nesting, headings, and indentation — with Hebrew right-to-left kept correct.",

    ...
    // ═══ FEATURED: personalization (led early, D-04) ═══════════════════════
    {
      ...
      topics: [
        ...
        },
        {
          ...
          priority: 2,
          body: [
            { type: "p", text: "במקטע {ui:settings.tab.fields} אפשר לשנות את שמם של רוב מקטעי המפגש למילים המדויקות שבהן אתם משתמשים מול הלקוחות, כך שהטופס ידבר בשפה שלכם. כמה מקטעים קבועים שומרים על שמם, אבל עדיין אפשר לכבות אותם." }
          ]
        },
        {
      ...
      topics: [
        {
          ...
          body: [
            ...
            { type: "steps", items: [
              ...
              "להגדיר {ui:session.form.beforeSeverity} בתחילת המפגש, בסולם של 0 עד 10.",
      ...
      topics: [
        {
          ...
          body: [
            ...
            { type: "steps", items: [
              ...
              "לבחור אילו חלקים מהמפגש לכלול. דירוגי הרגשות לפני ואחרי מסומנים מראש — אפשר לבטל את הסימון כדי להשאיר את דירוגי החומרה מחוץ לייצוא הזה.",

      ...
      topics: [
        {
          ...
          body: [
            ...
            { type: "note", text: "השינוי הזה משפיע על מה שמופיע בכל מקום שבו מתעדים מפגש — שום דבר לא נמחק אף פעם. כיבוי של מקטע שומר על מקומו ברשימה, כך שכשמפעילים אותו מחדש הוא חוזר בדיוק למקום שבו היה." }
          ]
        },
        {
          id: "topic-reordering",
          title: "שינוי סדר המקטעים",
          priority: 1,
          body: [
            { type: "p", text: "סדרו את מקטעי המפגש לפי הסדר שבו אתם באמת עובדים. אותו סדר עובר גם לטופס המפגש וגם לייצוא." },
            { type: "steps", items: [
              "לפתוח את ההגדרות ולעבור אל {ui:settings.tab.fields}.",
              "לגרור מקטע בעזרת הידית שלו, או להשתמש בחצי המעלה והמורידה, כדי להזיז אותו.",
              "מקטעים קשורים יושבים בקבוצה שאפשר לשנות את שמה — גררו את הקבוצה כדי להזיז אותה כמקשה אחת.",
        ...
        },
        {
          ...
          priority: 2,
          body: [
            { type: "p", text: "במקטע {ui:settings.tab.fields} אפשר לשנות את שמם של רוב מקטעי המפגש למילים המדויקות שבהן אתם משתמשים מול הלקוחות, כך שהטופס ידבר בשפה שלכם. גם את הקבוצות שמכילות מקטעים קשורים אפשר לשנות. כמה מקטעים קבועים שומרים על שמם, אבל עדיין אפשר לכבות אותם." },
            { type: "note", text: "שיניתם דעתכם? {ui:settings.reset.names.label} מחזיר כל שם מקטע וכל שם קבוצה לברירת המחדל." }
          ]
        },
        {
      ...
      topics: [
        {
          ...
          body: [
            ...
            { type: "p", text: "פותחים את המפגש, מרחיבים את המקטע שרוצים לכתוב בו — {ui:session.accordion.emotions}, הערות המפגש או כל מקטע אחר — ומקלידים או מדביקים את מה שעולה, במילים שלכם. הסידור והעיצוב יכולים לחכות עד שמסיימים." }
          ]
        },
        {
          id: "topic-formatting",
      ...
      topics: [
        ...
        },
        {
          ...
          body: [
            ...
            { type: "list", items: [
              "מופעל — כל נושא מקבל דירוג בהתחלה, ומקטע דירוגי סוף-המפגש מופיע.",
      ...
      topics: [
        {
          ...
          body: [
            ...
            { type: "list", items: [
              "המקטעים מופיעים בסדר שקבעתם בהגדרות.",
              ...
              "'חזרה' ו'המשך' שומרים על העריכות שלכם. המסמך נבנה מחדש רק כשמשנים את בחירת המקטעים — והאפליקציה שואלת קודם.",
        ...
        },
        {
          ...
          body: [
            ...
            { type: "p", text: "כך או כך, המקטעים יוצאים בסדר שקבעתם בהגדרות, ודירוגי החומרה יושבים במקום שבו נופל אותו מקטע בסדר שלכם. אם תמחקו כותרת מקטע תוך כדי עריכה, בלוק החומרה יעלה למעלה בהתאם." },
      ...
      topics: [
        ...
        },
        {
          ...
          body: [
            ...
            { type: "note", text: "שחזור מחזיר את סדר המקטעים ואת שמות הקבוצות שלכם יחד עם הלקוחות והמפגשים." },

      ...
      topics: [
        {
          ...
          body: [
            ...
            { type: "note", text: "הקישו שוב על דירוג כדי לנקות אותו בחזרה לללא-דירוג — ניקוי דירוג ההתחלה מנקה איתו גם את דירוג הסיום של אותו נושא. נושא ללא דירוג נשאר מחוץ לייצוא ומופיע בשמו בלבד בהיסטוריית המפגשים." }
          ]
        },
        {
          id: "topic-turn-off",

...
window.I18N.he = {
  ...
  "export.step1.helper": "שלב 1 מתוך 3 — בחרי אילו חלקים של המפגש לכלול בייצוא. הבחירה כאן קובעת מה יופיע בעורך התצוגה המקדימה בשלב הבא.",
  "export.step2.helper": "שלב 2 מתוך 3 — ערכי את המסמך משמאל; התצוגה החיה מימין מראה כיצד הוא ייראה. טיפים לעיצוב מופיעים למטה במידת הצורך.",
  "export.step3.helper": "שלב 3 מתוך 3 — בחרי כיצד להעביר את המסמך. PDF מתאים להדפסה או דוא\"ל; קובץ הטקסט עובד בכל עורך טקסט; שיתוף פותח את גיליון השיתוף של המכשיר (אם נתמך).",

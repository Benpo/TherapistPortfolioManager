      ...
      topics: [
        {
          ...
          body: [
            ...
            { type: "note", text: "Not sure how it will look? Each note field's toolbar has an Edit / Preview switch. Tap Preview and a clearly framed preview replaces the field in place — one clean view at a time — so you can see your formatting take shape. The switch always shows which mode you are in: the active side is highlighted. While you preview, the formatting buttons rest dimmed — to go back to writing, tap Edit or press Ctrl+E — Cmd+E on a Mac. Your snippets and the way a field grows to fit your text work just as before, and your formatting is saved with the notes, so it reads back as styled text and stays intact when you export." }
          ]
        },
        {
          id: "topic-snippets",

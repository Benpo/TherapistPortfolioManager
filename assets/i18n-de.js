...
window.I18N.de = {
  ...
  "overview.table.nextSession": "Nächste Sitzung",
  "overview.table.nextSession.overdue": "Überfällig",
  ...
  "overview.heartShield.active": "Aktive Heart-Wall",
  "overview.heartShield.removed": "Heart-Wall entfernt",
  ...
  "overview.filter.sort.nextSession": "Nächste Sitzung",
  "overview.filter.sort.sessions": "Anzahl Sitzungen",
  "overview.filter.clear": "Filter zurücksetzen",
  "filter.sessionFormat": "Sitzungsart",
  "filter.sessionFormat.all": "Alle Arten",
  "filter.sessionFormat.count": "{count} ausgewählt",
  ...
  "session.form.sessionType": "Sitzungsart",
  "session.form.sessionType.more": "＋ {count} weitere",
  "session.form.clinic": "Vor Ort",
  "session.form.online": "Online",
  "session.form.other": "Sonstiges",
  "session.form.date": "Sitzungsdatum *",
  "session.form.heartShield": "Heart-Wall-Sitzung",
  "session.accordion.emotions": "Emotionen & Techniken",
  "session.group.wrapup": "Sitzungsabschluss",
  "session.form.comments.title": "Sitzungsnotizen",
  "session.form.shieldRemoved": "Heart-Wall entfernt?",
  "session.form.shieldRemoved.yes": "Ja",
  "session.form.shieldRemoved.no": "Nein",
  "session.form.heartShieldEmotions": "Emotionen in der Heart-Wall",
  "session.form.heartShieldEmotions.placeholder": "Die in der Heart-Wall gefundenen Emotionen auflisten",
  ...
  "session.form.nextSessionDate": "Datum der nächsten Sitzung",
  ...
  "session.copy.type": "Sitzungsart:",
  "session.copy.heartShield": "Heart-Wall aufgelöst:",
  ...
  "session.form.afterSeverityTitle": "Schweregrad — Sitzungsende",
  ...
  "photos.heading": "Fotos",
  "photos.helper": "Verwalten Sie, wie Klientenfotos Ihren Browser-Speicher nutzen.",
  "photos.usage.line": "Fotos nutzen {size} Ihres Browser-Speichers.",
  "photos.usage.unavailable": "Speichernutzung ist in diesem Browser nicht verfügbar.",
  "photos.usage.body": "Fotos belegen {size} des Browser-Speichers.",
  "photos.usage.compact": "Fotos belegen {size} des Browser-Speichers. Bereits kompakt — Optimieren bringt nichts.",
  "photos.usage.optional": "Fotos belegen {size} des Browser-Speichers. Optimieren könnte etwa {savings} freigeben (optional).",
  "photos.usage.recommended": "Fotos belegen {size} des Browser-Speichers. Optimieren könnte etwa {savings} freigeben — empfohlen.",
  "photos.empty": "Sie haben noch keine Klientenfotos.",
  ...
  "photos.optimize.confirm.yes": "Ja, optimieren",
  "photos.optimize.success": "Fotos optimiert. {size} eingespart.",
  "photos.optimize.partialFailure": "{success} Fotos optimiert. {failed} konnten nicht verarbeitet werden und blieben unverändert.",
  ...
  "toast.exportDisabledDemo": "Export ist im Demo-Modus nicht verf\u00fcgbar",
  ...
  "confirm.resetApp.title": "App zurücksetzen?",
  "confirm.resetApp.body": "Dadurch werden alle Daten auf diesem Gerät dauerhaft gelöscht und eine frische, leere App neu geladen. Das lässt sich nicht rückgängig machen. Stelle sicher, dass dein Backup an einem sicheren Ort gespeichert ist.",
  "confirm.resetApp.yes": "Ja, zurücksetzen",
  "confirm.resetAppNoBackup.title": "Du hast noch kein Backup exportiert",
  "confirm.resetAppNoBackup.body": "Beim Zurücksetzen werden ALLE Klienten- und Sitzungsdaten auf diesem Gerät dauerhaft gelöscht. In dieser Sitzung wurde kein Backup exportiert. Wenn du jetzt ohne Backup zurücksetzt, können deine Daten nicht wiederhergestellt werden. Bist du dir absolut sicher?",
  "confirm.resetAppNoBackup.yes": "Zurücksetzen und alles löschen",
  "confirm.resetAppNoBackup.cancel": "Zurück und zuerst exportieren",
  ...
  "reporting.heartShieldCleared": "Sitzungen mit aufgelöster Heart-Wall",
  ...
  "session.type.remote": "Aus der Ferne",
  "session.type.proxy": "Stellvertretend",
  ...
  "backup.action.share": "Backup teilen",
  ...
  "backup.contents.helper": "Jeder Export enth\u00e4lt alle unten aufgef\u00fchrten Punkte.",
  ...
  "settings.report.label": "Problem melden",
  "settings.report.desc": "Etwas funktioniert nicht? Kopieren Sie einen Diagnosebericht und senden Sie ihn per E-Mail an den Support. Es wird nichts automatisch \u00FCbermittelt.",
  "settings.report.clear.label": "Problemprotokoll leeren",
  "settings.report.clear.confirm.title": "Problemprotokoll leeren?",
  "settings.report.clear.confirm.body": "Dadurch wird das auf diesem Ger\u00E4t gespeicherte Diagnoseprotokoll geleert. Ihre Klienten und Sitzungen sind davon nicht betroffen.",
  "settings.report.clear.confirm.yes": "Protokoll leeren",
  "settings.report.cleared.toast": "Problemprotokoll geleert",
  "report.page.title": "Problem melden",
  "report.intro": "Es wird nichts automatisch gesendet. Pr\u00FCfen Sie den Bericht unten, kopieren Sie ihn und f\u00FCgen Sie ihn in eine E-Mail an den Support ein. Ihre Daten bleiben auf diesem Ger\u00E4t.",
  "report.preview.label": "Berichtsvorschau (vor dem Kopieren bearbeitbar)",
  "report.empty.heading": "Keine Probleme protokolliert",
  "report.empty.body": "Auf diesem Ger\u00E4t ist in letzter Zeit nichts schiefgelaufen. Falls dennoch ein Problem besteht, k\u00F6nnen Sie es per E-Mail an den Support beschreiben.",
  "report.action.copy": "Bericht kopieren",
  "report.action.email": "E-Mail an den Support \u00F6ffnen",
  "report.support.prefix": "Support-Adresse:",
  "report.copy.success": "Bericht kopiert \u2014 f\u00FCgen Sie ihn in Ihre E-Mail an den Support ein",
  "report.copy.failed": "Automatisches Kopieren nicht m\u00F6glich \u2014 markieren Sie den Text und kopieren Sie ihn manuell",
  "report.email.subject": "Sessions Garden \u2014 Problembericht",
  "report.email.body": "Bitte beschreiben Sie hier, was passiert ist, und f\u00FCgen Sie dann Ihren kopierten Bericht unterhalb dieser Linie ein.\n\n---\n",
  ...
  "settings.row.heartShield.description": "Heart-Wall-Sitzung: Schalter und Steuerung",
  "settings.row.heartShieldEmotions.description": "In der Heart-Wall gefundene Emotionen",
  "settings.row.issues.description": "Die Themen, die Sie in dieser Sitzung behandelt haben",
  "settings.row.comments.description": "Freie Notizen und Beobachtungen",
  "settings.reorder.dragHandle.aria": "{section} neu anordnen",
  "settings.reorder.moveUp.aria": "{section} nach oben verschieben",
  "settings.reorder.moveDown.aria": "{section} nach unten verschieben",
  "settings.reset.order.label": "Reihenfolge zurücksetzen",
  "settings.reset.names.label": "Namen zurücksetzen",
  "settings.reset.names.confirm": "Alle benutzerdefinierten Namen durch die Standardnamen ersetzen? Von Ihnen eingegebene Namen gehen verloren.",
  "settings.row.afterSeverity.label": "Schweregrad",
  "settings.row.afterSeverity.info": "Ein Schalter für alle Schweregrad-Bewertungen: Ist er an, erhält jedes Thema am Anfang eine Bewertung und dieser Abschnitt am Sitzungsende erscheint; ist er aus, verschwinden beide — die Themen selbst bleiben. Ziehen Sie diese Zeile, um festzulegen, wo die Bewertungen am Sitzungsende im Formular erscheinen.",
  ...
  // Phase 25 Plan 05 — Backups + Photos tabs
  "settings.tab.backups": "Backups",
  "settings.tab.photos": "Fotos",
  // Phase 37 — Personalization tab [translations ASSUMED — pending Sapir/Ben native review]
  "settings.tab.personalize": "Personalisierung",
  "settings.dateFormat.label": "Datumsformat",
  "settings.dateFormat.auto": "Automatisch (der Sprache folgen)",
  "settings.dateFormat.savedToast": "Datumsformat aktualisiert.",
  "settings.sessionTypes.heading": "Sitzungsarten",
  "settings.sessionTypes.helper": "Benennen Sie die integrierten Arten um oder fügen Sie eigene hinzu.",
  "settings.sessionTypes.add.label": "Art hinzufügen",
  "settings.sessionTypes.add.placeholder": "Neue Sitzungsart",
  "settings.sessionTypes.add.saveAria": "Neue Art speichern",
  "settings.sessionTypes.add.invalid": "Geben Sie einen Namen ein, der noch nicht in der Liste steht.",
  "settings.sessionTypes.locked.tooltip": "Integrierte Arten können umbenannt, aber nicht gelöscht werden.",
  "settings.sessionTypes.rename.aria": "Diese Sitzungsart umbenennen",
  "settings.sessionTypes.delete.aria": "Diese Sitzungsart löschen",
  "settings.sessionTypes.savedToast": "Sitzungsarten aktualisiert.",
  "settings.sessionTypes.empty": "Noch keine eigenen Arten. Fügen Sie unten eine hinzu.",
  "settings.sessionTypes.confirm.delete.title": "Diese Sitzungsart löschen?",
  "settings.sessionTypes.confirm.delete.body": "Bestehende Sitzungen, die sie verwendet haben, behalten ihren gespeicherten Wert.",
  "settings.sessionTypes.confirm.delete.confirm": "Art löschen",
  "settings.sessionTypes.confirm.reassign.title": "Diese Sitzungsart löschen?",
  "settings.sessionTypes.confirm.reassign.body": "{count} Sitzungen verwenden diese Art. Trotzdem löschen? Diese Sitzungen werden auf „Andere“ umgestellt.",
  "settings.sessionTypes.confirm.reassign.confirm": "Trotzdem löschen",
  "schedule.heading": "Geplante Backups",
  "schedule.helper": "Planen Sie regelmäßige Backup-Erinnerungen und wählen Sie den Speicherort.",
  "schedule.frequency.label": "Backup-Häufigkeit",
  "schedule.frequency.customDaysLabel": "Tage",
  "schedule.frequency.off": "Aus",
  "schedule.frequency.daily": "Täglich",
  "schedule.frequency.weekly": "Wöchentlich",
  ...
  "schedule.frequency.helperOn": "Eine Backup-Aufforderung erscheint, wenn dieses Intervall verstreicht.",
  ...
  "schedule.disableConfirm.cancel": "Zeitplan aktiviert lassen",
  "reminders.helper.heading": "Wie Erinnerungen funktionieren",
  "reminders.helper.body": "Ohne Zeitplan erscheint nach 7 Tagen ohne Backup ein dezenter Erinnerungs-Banner in der Übersicht. Wenn Sie einen Zeitplan einrichten, fordert Sessions Garden Sie im gewählten Intervall direkt in der App auf — und der 7-Tage-Banner bleibt still, sodass Sie nur einen Kanal erhalten. Wenn Sie den Zeitplan deaktivieren, wird der 7-Tage-Erinnerungs-Banner wieder aktiv.",
  ...
  "export.section.topics": "Sitzungsthemen",
  "export.suboption.includeSeverity": "Schweregrad vorher/nachher einschließen",
  "export.step2.helper": "Schritt 2 von 3 \u2014 Bearbeiten Sie Ihr Dokument unten; wechseln Sie jederzeit zur Vorschau, um zu sehen, wie es aussehen wird.",
  "export.ephemeralNote": "\u00c4nderungen hier gelten nur f\u00fcr diesen Export. Strukturieren Sie frei um \u2014 nichts wird zur\u00fcck in die Sitzung gespeichert.",
  "export.maximize": "Editor maximieren",
  "export.restore": "Gr\u00f6\u00dfe wiederherstellen",
  ...
  "snippets.filter.origin.all": "Alle",
  "snippets.filter.origin.mine": "Meine",
  "snippets.filter.origin.defaults": "Standard",
  "snippets.filter.origin.label": "Snippets nach Quelle filtern",
  ...
  "snippets.editor.trigger.error.format": "Ausl\u00F6ser d\u00FCrfen keine Leerzeichen enthalten. Verwenden Sie stattdessen einen Bindestrich, z. B. physical-trauma.",
  ...
  "snippets.lang.name.cs": "Tschechisch",
  ...
  // DE (Sie) machine-DRAFT, flagged for the Phase 42.1 native-speaker pass. No left/right words;
  // real nav.*/settings.tab.* labels quoted.
  // Titles as Substantiv/Infinitiv, never bare imperatives. Keep {screen}/{n}/{total} tokens verbatim.
  "help.tour.step.overview.title": "Willkommen in Ihrem Garten",
  "help.tour.step.overview.body": "Das ist Ihre Startseite — sie begrüßt Sie bei jedem Besuch. Bevor die Arbeit beginnt, machen wir diesen Ort zu Ihrem; dann gehen wir den Weg, den eine Sitzung nimmt. Steigen Sie aus, wann immer Sie möchten.",
  "help.tour.step.settings.title": "Es zu Ihrem machen",
  "help.tour.step.settings.body": "Hinter diesem kleinen Zahnrad liegen die Einstellungen — wo Sie die App zu Ihrer machen. Treten wir gemeinsam ein.",
  "help.tour.step.personalize.title": "Ihre Formate und Daten",
  "help.tour.step.personalize.body": "Da sind wir — die Einstellungen. Hier gestalten Sie Ihre Sitzungsformate — benennen Sie sie um, damit sie zu der Arbeit passen, die Sie wirklich tun, oder fügen Sie eigene hinzu. Auch die Datumsangaben leben hier: wählen Sie den Stil, den Ihre Augen gewohnt sind.",
  "help.tour.step.fields.title": "Feldnamen anpassen",
  "help.tour.step.fields.body": "Jedes Sitzungsformular beginnt mit fertigen Abschnitten. Benennen Sie jeden davon um — machen Sie das Formular wirklich zu Ihrem — und schalten Sie ab, was Sie nicht nutzen. Alles, was Sie ausschalten, ist nur ausgeblendet; Sie können es jederzeit zurückholen.",
  "help.tour.step.snippets.title": "Textexpander / Textbausteine",
  "help.tour.step.snippets.body": "Das wird vielleicht Ihre Lieblingsecke: Textbausteine. Alles, was Sie immer wieder schreiben — ein Satz, ein Stichwort, eine ganze Abschlussnotiz — speichern Sie es hier einmal, in Ihren eigenen Worten, und verwenden Sie es in jeder Sitzung wieder.",
  "help.tour.step.ready.title": "Bereit zu beginnen",
  "help.tour.step.ready.body": "Jetzt wissen Sie, wo die Personalisierung wohnt — machen Sie sie zu Ihrer, wann immer Sie bereit sind. Dieses Menü begleitet Sie auf jeder Seite. Wenn jemand Neues ankommt, heißt Neuer Klient ihn willkommen; Neue Sitzung beginnt die Arbeit selbst. Öffnen wir gemeinsam eine Sitzung.",
  "help.tour.step.setup.title": "Eine Sitzung aufzeichnen",
  "help.tour.step.setup.body": "Da sind wir — eine frische Sitzung. Sie beginnt sanft: der Klient, das Datum und das Format — genau die Formate, die Sie eben benannt haben. Ist jemand neu, können Sie ihn gleich hier hinzufügen.",
  "help.tour.step.heart.title": "Das Herz der Sitzung",
  "help.tour.step.heart.body": "Hier lebt die Arbeit — jede eingeschlossene Emotion, die Sie finden und lösen. In der Nähe sitzen die Intensitätsskalen — wie schwer sich jedes Thema anfühlte, vorher und nachher — und der Heart-Wall-Abschnitt. Wenn etwas davon nicht zu Ihrer Arbeit gehört, denken Sie daran: Jeder Abschnitt lässt sich in den Einstellungen umbenennen oder abschalten.",
  "help.tour.step.save.title": "Ihre Arbeit sichern",
  "help.tour.step.save.body": "Wenn Sie speichern, legt sich die Sitzung sicher auf diesem Gerät ab — nichts verlässt es. Öffnen Sie später eine gespeicherte Sitzung und teilen Sie sie als klientenfertiges PDF über die Schaltfläche Exportieren oben.",
  "help.tour.step.sessions.title": "Zurückblicken",
  "help.tour.step.sessions.body": "Wir sind über den Reiter Sitzungen angekommen — er ist hier im Menü, auf jeder Seite. Alles, was Sie speichern, sammelt sich auf dieser Seite, bereit zum Durchsehen, Filtern und Wiederfinden.",
  "help.tour.step.backup.title": "Eine Sicherung behalten",
  "help.tour.step.backup.body": "Alles hier lebt nur auf diesem Gerät — deshalb zählen regelmäßige Sicherungen. Diese kleine Wolke erstellt eine verschlüsselte Sicherung von allem, und ihre Farbe zeigt sanft, wann die nächste fällig ist.",
  "help.tour.step.help.title": "Sie sind bereit",
  "help.tour.step.help.body": "Das ist der ganze Weg — wenn auch nicht ganz Sessions Garden. Hinter diesem Fragezeichen liegt das Hilfezentrum: Anleitungen in klarer Sprache zu allem, was wir nicht behandelt haben — wie oft Ihre Sicherungen laufen, die Bausteinbibliothek, die Heart-Wall, die Wahl eines Exportformats und mehr.\n\nEs gibt noch mehr in der App zu entdecken, etwa den Reiter Statistiken, der Ihre Sitzungen still mit der Zeit in Zahlen verwandelt — und dieses Fragezeichen ist auf jeder Seite bei Ihnen.",
  "help.tour.next": "Weiter",
  "help.tour.done": "Fertig",
  "help.tour.back": "Vorheriger Schritt",
  "help.tour.close": "Tour schließen",
  "help.tour.counter": "Schritt {n} von {total}",
  "help.tour.fallbackBody": "Das befindet sich auf dem Bildschirm {screen}.",
  "help.tour.takeMeThere": "Dorthin bringen",
  "help.tour.exit.title": "Tour verlassen?",
  "help.tour.exit.remindLater": "Später erinnern",
  "help.tour.exit.exploreMyself": "Ich schaue mich selbst um",
  "help.tour.reminder.title": "Bereit, die Tour abzuschließen?",
  "help.tour.reminder.start": "Starten",
  "help.tour.reminder.dismiss": "Ausblenden",
  "help.tour.finish.title": "Alles bereit",
  "help.tour.finish.body": "Ihr Garten ist bereit. Wann immer Sie möchten, machen Sie den ersten kleinen Schritt.",
  ...
  "help.chrome.startHere": "Hier beginnen",
  "help.chrome.sessionLoop": "Der Sitzungsablauf",
  "help.chrome.technicalBits": "Die technischen Aspekte",
  "help.chrome.spine": "Der Sitzungsablauf — vom ersten Klienten bis zur fertigen Sitzung",
  "help.chrome.techBand": "Die technischen Aspekte, in klarer Sprache",
  "help.chrome.intro": "Ein ruhiger Gang durch das Führen einer Sitzung in Sessions Garden, von Anfang bis Ende — und die technischen Aspekte, in klarer Sprache.",
  "help.chrome.jumpToSection": "Zu einem Abschnitt springen",
  "help.chrome.contactTitle": "Brauchen Sie noch Hilfe?",
  "help.chrome.contactBody": "Wenn Sie nicht gefunden haben, wonach Sie gesucht haben, schreiben Sie uns — ein echter Mensch liest jede Nachricht.",
  "help.chrome.reportHint": "Etwas funktioniert nicht richtig? Nutzen Sie 'Problem melden' in den Einstellungen, um einen Diagnosebericht in Ihre E-Mail zu kopieren — nichts wird jemals automatisch gesendet.",
  "help.chrome.ariaSections": "Hilfebereiche",
  "help.chrome.ariaSearch": "Hilfe durchsuchen",
  "help.chrome.ariaShowTopics": "Themen anzeigen",
  "help.tour.screen.overview": "Übersicht",
  "help.tour.screen.settings": "Einstellungen",
  "help.tour.screen.session": "Sitzung",
  "help.tour.screen.sessions": "Sitzungen",
  ...
  "onboard.install.ctaInstall": "App installieren",
  "onboard.install.safariHint": "Öffnen Sie in Safari das Menü „Ablage“ und wählen Sie „Zum Dock hinzufügen“.",
  "onboard.install.safariLink": "Installationshilfe ansehen",
  "onboard.install.dismiss": "Nein, danke",
  "onboard.install.laterHint": "Sie können die App jederzeit über die Hilfe installieren.",
  "onboard.mobileHint.body": "Sessions Garden ist für Computer konzipiert. Auf einem Telefon liegen Ihre Daten auf jedem Gerät getrennt — sie wandern nicht zwischen Ihrem Telefon und Ihrem Computer.",
  "onboard.mobileHint.link": "Wie Sessions Garden auf dem Handy funktioniert",
  "onboard.mobileHint.dismiss": "Verstanden",

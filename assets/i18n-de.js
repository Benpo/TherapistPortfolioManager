...
window.I18N.de = {
  ...
  "settings.sessionTypes.heading": "Sitzungstypen",
  "settings.sessionTypes.helper": "Benennen Sie die integrierten Typen um oder fügen Sie eigene hinzu.",
  "settings.sessionTypes.add.label": "Typ hinzufügen",
  "settings.sessionTypes.add.placeholder": "Neuer Sitzungstyp",
  "settings.sessionTypes.add.saveAria": "Neuen Typ speichern",
  "settings.sessionTypes.add.invalid": "Geben Sie einen Namen ein, der noch nicht in der Liste steht.",
  "settings.sessionTypes.locked.tooltip": "Integrierte Typen können umbenannt, aber nicht gelöscht werden.",
  "settings.sessionTypes.rename.aria": "Diesen Sitzungstyp umbenennen",
  "settings.sessionTypes.delete.aria": "Diesen Sitzungstyp löschen",
  "settings.sessionTypes.savedToast": "Sitzungstypen aktualisiert.",
  "settings.sessionTypes.empty": "Noch keine eigenen Typen. Fügen Sie unten einen hinzu.",
  "settings.sessionTypes.confirm.delete.title": "Diesen Sitzungstyp löschen?",
  "settings.sessionTypes.confirm.delete.body": "Bestehende Sitzungen, die ihn verwendet haben, behalten ihren gespeicherten Wert.",
  "settings.sessionTypes.confirm.delete.confirm": "Typ löschen",
  "settings.sessionTypes.confirm.reassign.title": "Diesen Sitzungstyp löschen?",
  "settings.sessionTypes.confirm.reassign.body": "{count} Sitzungen verwenden diesen Typ. Trotzdem löschen? Diese Sitzungen werden auf „Andere“ umgestellt.",

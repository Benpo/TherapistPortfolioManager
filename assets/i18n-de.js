...
window.I18N.de = {
  ...
  "schedule.folder.label": "Backup-Ordner",
  "schedule.folder.helper": "Optional. Beim nächsten Speichern eines geplanten Backups schlägt Ihr Browser diesen Ordner vor.",
  "schedule.folder.empty": "Kein Ordner ausgewählt.",
  "schedule.folder.unsupported": "Die Ordnerauswahl ist nur in Chromium-basierten Browsern (Chrome, Edge, Brave) verfügbar.",
  "schedule.folder.pick": "Backup-Ordner wählen",
  "schedule.folder.repick": "Ordner: {name} — Neu wählen",

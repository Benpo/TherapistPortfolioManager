...
window.I18N.de = {
  ...
  // Replayable guided tour — UI chrome (Phase 41); DE (Sie) flagged for TOUR-01 native-speaker review.
  ...
  "help.tour.step.overview.body": "Das ist Ihre ruhige Basis. Gehen wir gemeinsam einen Sitzungsablauf durch, von Anfang bis Ende — in Ihrem eigenen Tempo. Sie können jederzeit aussteigen.",
  "help.tour.step.addClient.title": "Einen Klienten hinzufügen",
  "help.tour.step.addClient.body": "Jeder Weg beginnt mit einem Menschen. Hier fügen Sie einen neuen Klienten zu Ihrem Garten hinzu.",
  "help.tour.step.startSession.title": "Eine Sitzung beginnen",
  "help.tour.step.startSession.body": "Wenn Sie sich an die Arbeit setzen, öffnen Sie von hier aus eine Sitzung.",
  "help.tour.step.setup.title": "Den Rahmen setzen",
  "help.tour.step.setup.body": "Sie beginnen mit der Wahl des Klienten, des Datums und der Art des Kontakts — in der Praxis, online oder auf andere Weise.",
  "help.tour.step.heart.title": "Das Herz einer Sitzung",
  "help.tour.step.heart.body": "Hier erfassen Sie die eingeschlossenen Emotionen, ihre Intensität und ob eine Heart-Wall vorhanden ist. Das ist der Kern der Arbeit.",
  "help.tour.step.save.title": "Sichern und bewahren",
  "help.tour.step.save.body": "Beim Speichern wird die Sitzung auf diesem Gerät abgelegt. Sie können jede Sitzung auch als PDF exportieren — achten Sie auf dieses Export-Symbol.",
  "help.tour.step.sessions.title": "Zurückblicken",
  "help.tour.step.sessions.body": "Alle Ihre gespeicherten Sitzungen sammeln sich hier, bereit zum Durchsehen, Filtern und Wiederfinden.",
  "help.tour.step.reporting.title": "Das ganze Bild sehen",
  "help.tour.step.reporting.body": "Das Dashboard zeigt behutsam Muster in Ihrer Arbeit im Laufe der Zeit.",
  "help.tour.step.backup.title": "Eine Kopie behalten",
  "help.tour.step.backup.body": "Ihre Daten liegen nur auf diesem Gerät — deshalb zählt eine Sicherung. Hier exportieren Sie eine sichere Kopie.",
  "help.tour.step.help.title": "Sie sind bereit",
  "help.tour.step.help.body": "Das ist der ganze Weg. Das Hilfe-Center ist immer da, wenn Sie es brauchen — Sie finden es unter diesem Fragezeichen.",

...
window.I18N.de = {
  ...
  "help.tour.step.settings.body": "Hinter diesem kleinen Zahnrad liegen die Einstellungen — wo die App Ihre Gestalt annimmt. Treten wir gemeinsam ein.",
  "help.tour.step.personalize.title": "Ihre Formate und Daten",
  "help.tour.step.personalize.body": "Da sind wir — die Einstellungen. Zuerst Ihre Sitzungsformate: benennen Sie die Arten von Arbeit, die Sie wirklich tun, und fügen Sie eigene hinzu. Auch die Datumsangaben leben hier — wählen Sie das Format, das Ihre Augen gewohnt sind.",
  "help.tour.step.fields.title": "Ihre Felder",
  "help.tour.step.fields.body": "Jedes Sitzungsformular beginnt mit fertigen Abschnitten. Benennen Sie jeden davon um — machen Sie das Formular wirklich zu Ihrem — und schalten Sie ab, was Sie nicht nutzen. Nichts, was Sie deaktivieren, wird je gelöscht.",
  "help.tour.step.snippets.title": "Ihre Worte",
  ...
  "help.tour.step.ready.body": "Die App spricht nun Ihre Sprache. Dieses Menü begleitet Sie auf jeder Seite. Wenn jemand Neues ankommt, heißt Neuer Klient ihn willkommen; Neue Sitzung beginnt die Arbeit selbst. Öffnen wir gemeinsam eine Sitzung.",
  "help.tour.step.setup.title": "Den Rahmen setzen",
  ...
  "help.tour.step.heart.body": "Hier lebt die Arbeit — jede eingeschlossene Emotion, die Sie finden und lösen. In der Nähe sitzen die Intensitätsskalen — wie schwer sich jedes Thema anfühlte, vorher und nachher — und der Heart-Wall-Abschnitt.",
  ...
  "help.tour.step.backup.title": "Eine Kopie behalten",
  "help.tour.step.backup.body": "Alles hier lebt nur auf diesem Gerät — deshalb zählt eine Kopie. Diese kleine Wolke erstellt eine verschlüsselte Sicherung, und ihre Farbe zeigt sanft, wann eine fällig ist.",
  "help.tour.step.help.title": "Sie sind bereit",
  "help.tour.step.help.body": "Das ist der ganze Weg — wenn auch nicht ganz Sessions Garden. Hinter diesem Fragezeichen liegt das Hilfezentrum: Anleitungen in klarer Sprache zu allem, was wir nicht begangen haben — wie oft Ihre Sicherungen laufen, die Bausteinbibliothek, die Heart-Wall, die Wahl eines Exportformats und mehr. Es gibt noch mehr in der App zu entdecken, etwa den Reiter Statistiken, der Ihre Sitzungen still mit der Zeit in Zahlen verwandelt. Es ist auf jeder Seite hier — und diese Tour wartet daneben, wann immer Sie erneut gehen möchten.",
